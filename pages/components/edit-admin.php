        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="form-group text-center">
              <img src="<?= $admin->avatar ? $admin->avatar : "$SERVER_NAME ?>/west/assets/dist/img/no-image-available.png" ?>" alt="My Avatar" id="cimg" class="img-fluid student-img bg-gradient-dark border" style="width: 217px; height: 217px;">
            </div>
          </div>
        </div>
        <hr>
