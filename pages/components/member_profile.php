        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="form-group text-center">
              <img src="<?= $member->avatar == null ? "$SERVER_NAME/assets/dist/img/no-image-available.png" : $SERVER_NAME . $member->avatar ?>" alt="My Avatar" id="cimg" class="img-fluid student-img bg-gradient-dark border" style="width: 217px; height: 217px;">
            </div>
          </div>
        </div>
        <hr>
