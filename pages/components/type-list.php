  ...
  <div class="card-header">
    <div class="row mb-2">
      ...
      <div class="col-sm-6 d-flex justify-content-end">
        <button type="button" class="btn btn-primary" style="height: 38px;" onclick="handleOpenModal()">Add Type</button>
      </div>
    </div>
  </div>
  <!-- /.card-header -->
        ...
        ?>
          <tr>
            ...
            <td class="text-center">
              <button type="button" class="btn btn-warning btn-sm m-1" onclick="handleOpenModal('<?= $type->id ?>')">
                Edit
              </button>
              <button type="button" class="btn btn-danger btn-sm m-1" onclick="handleOnclickDeleteType('<?= $type->id ?>')">
                Delete
              </button>
            </td>
          </tr>
