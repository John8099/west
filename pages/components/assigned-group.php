              ...
              <tbody>
                    ...
                    <tr>
                      ...
                      <?php if ($i == 0) : ?>
                        <td rowspan="<?= count($groupRatingData["ratings"]) ?>">
                          <div class='form-group'>
                            <textarea class="form-control" cols="50" rows="<?= count($groupRatingData["ratings"]) + 2 ?>" name="<?= $index . "_remarks" ?>" required><?= $groupRatingData["remarks"] ?></textarea>
                          </div>
                        </td>
                      <?php endif; ?>
                    </tr>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <div class='form-group'>
                        <textarea class="form-control" cols="50" name="<?= $user_details->id ?>_remarks" required><?= $individualRating["remarks"] ?></textarea>
                      </div>
                    </td>
                  </tr>
                <?php endforeach ?>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td rowspan="3">
                      <div class='form-group'>
                        <textarea class="form-control" cols="50" rows="5" name="documentation_remarks" oninput="handleAddRemarks('documentation', $(this))" required></textarea>
                      </div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td rowspan="4">
                      <div class='form-group'>
                        <textarea class="form-control" cols="50" rows="10" name="system_remarks" oninput="handleAddRemarks('system', $(this))" required></textarea>
                      </div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td rowspan="4">
                      <div class='form-group'>
                        <textarea class="form-control" cols="50" rows="6" name="presentation_remarks" oninput="handleAddRemarks('presentation', $(this))" required></textarea>
                      </div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class='form-group'>
                        <textarea class="form-control" cols="50" rows="2" id="individual_remarks<?= $leader->id ?>" name="remarks<?= $leader->id ?>" oninput="handleIndividualRemarks('<?= $leader->id ?>', '<?= $leaderName ?>', $(this).val())" required></textarea>
                      </div>
                    </td>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          <div class='form-group'>
                            <textarea class="form-control" cols="50" rows="2" id="individual_remarks<?= $member->id ?>" name="remarks<?= $member->id ?>" oninput="handleIndividualRemarks('<?= $member->id ?>', '<?= $memberName ?>', $(this).val())" required></textarea>
                          </div>
                        </td>
