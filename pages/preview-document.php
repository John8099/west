        ...
        <div class="content" style="padding:9rem 0rem 0rem 0rem;">
          ...
          <div class="card card-outline card-primary shadow rounded-0">
            <div class="card-header">
              ...
              <small class="text-muted">Submitted by <b class="text-info"><?= $leader ? ucwords("$leader->first_name " . $leader->middle_name[0] . ". $leader->last_name") : "N/A" ?></b> on <?= date("F d, Y h:i:s A", strtotime($document->date_updated)) ?></small>
            </div>
